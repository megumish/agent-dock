...
- 意図的未決: D-02 の最終ストア（再評価トリガつき open — v0 に限界が出ない限り最終化を強制しない）。他の構造上の Decision は確定済み
...
- 確定 ADR: D-12（最終形）
- 意図的未決: D-02 の最終ストア（再評価トリガつき open）。他の構造的 Decision はここで全て確定 — 以後の変更は新しい D-xx として登録
