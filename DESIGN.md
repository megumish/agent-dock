...
評価イベントの記録、受け入れ判定、スコアカード、助言は後続の alpha で追加する。
したがって 0.1.0-alpha.1 の完成をもって、0.1.0 の循環または VISION の成功基準を達成したとはみなさない。
...
これはドックによる実行の仲介とは別の入口であり、0.1.0 の後続パッチ版で扱う。
